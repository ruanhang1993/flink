...
/**
 * Special {@link org.apache.flink.metrics.MetricGroup} representing an {@link
...
public class InternalSplitEnumeratorMetricGroup extends ProxyMetricGroup<MetricGroup>
    ...
    public InternalSplitEnumeratorMetricGroup(MetricGroup parent, String groupName) {
        super(parent.addGroup(groupName));
    }
