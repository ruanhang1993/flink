...
public class ExecutionEnvironmentOptions {
    ...
    public ExecutionEnvironmentOptions(List<URL> connectorJars) {
        this(connectorJars, null);
    }

    public ExecutionEnvironmentOptions(
            List<URL> connectorJars, @Nullable String savepointRestorePath) {
        this.connectorJars = connectorJars;
        this.savepointRestorePath = savepointRestorePath;
    }

    public List<URL> getConnectorJars() {
